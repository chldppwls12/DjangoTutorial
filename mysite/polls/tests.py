...
class QustionModelTests(TestCase):
  ...
  def test_was_published_recently_with_old_question(self):
    """
    was_published_recently() returns False for questions whoses pub_date
    is older than 1 day.
    """
  ...
  def test_was_published_recently_with_recent_question(self):
    ...
    """
    time = timezone.now() - datetime.timedelta(hours=3, minutes=59, seconds=59)
...
class QuestionDetailViewTests(TestCase):
  ...
  def test_past_question(self):
    """
    The detail view of a question a with a pub_date
